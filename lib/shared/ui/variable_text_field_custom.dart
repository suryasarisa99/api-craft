...
import 'package:api_craft/shared/ui/key_valu_text_builder.dart';
...
import 'package:api_craft/api_client/sidebar/context_menu.dart';
import 'package:api_craft/api_client/template_functions/models/template_placeholder_model.dart';
import 'package:api_craft/api_client/template_functions/parsers/parse.dart';
import 'package:api_craft/api_client/template_functions/template_function_registry.dart';
import 'package:api_craft/api_client/template_functions/widget/template_form_popup.dart';
import 'package:api_craft/shared/ui/filter.dart';
import 'package:api_craft/shared/ui/variable_text_builder.dart';
  ...
  void handleVariableTap({
    ...
    if (isVariable) {
      ...
      */
      ...
      if (name == 'secure') {
        final workspace = ref.read(workspaceNodeProvider)!;

        if (workspace.config.encryptedKey == null) {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: const Text(
                'This workspace needs to be encrypted before you can use secure values. '
              ...
              actions: [
                ...
                FilledButton(
                  onPressed: () async {
                    ...
                    try {
                      await ref
                          .read(workspaceSecurityServiceProvider)
                          .enableEncryption(workspace.id);
                      if (context.mounted) {
                        handleVariableTap(
