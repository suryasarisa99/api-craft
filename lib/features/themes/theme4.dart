...
ThemeData buildTheme4({required Brightness brightness, required Color color}) {
  ...
  final backgroundClr = const Color.fromARGB(255, 26, 28, 29);
  return ThemeData(
    ...
    extensions: [
      AppTheme(
        statusBarBackground: Color.fromARGB(255, 22, 23, 24),
        statusBarText: cs.onPrimaryContainer,
        topBarBackground: Color.fromARGB(255, 22, 23, 24),
      ...
      SidebarTheme(
        ...
        indentLine: const Color.fromARGB(255, 75, 75, 75),
