...
import 'package:api_craft/traffic/interception_rules/widgets/action_editor.dart';
...
import 'package:api_craft/shared/filter_conditions/widgets/filter_group.dart';
import 'package:api_craft/traffic/filter/filter_converter.dart';
        ...
        if (uiFilterJson is Map) {
          ...
          try {
            final tempNode = (uiFilterJson['type'] == 'group')
                ...
                : FilterCondition.fromJson(uiFilterJson);
