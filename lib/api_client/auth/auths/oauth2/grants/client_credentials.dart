import 'package:api_craft/api_client/auth/auths/oauth2/fetch_access_token.dart';
import 'package:api_craft/api_client/auth/auths/oauth2/get_or_refresh_access_token.dart';
import 'package:api_craft/api_client/auth/auths/oauth2/store.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

Future<AccessTokenRawResponse> getClientCredentials(
  Ref ref,
  Map<String, dynamic> args,
) async {
  final contextId = 'default'; // TODO: Pass contextId
