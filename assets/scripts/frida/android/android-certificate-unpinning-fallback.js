          ...
          callingMethod.overloads.forEach((failingMethod) => {
            ...
            if (isOkHttpCheckMethod(errorMessage, failingMethod)) {
              ...
              failingMethod.implementation = function (certs) {
                if (DEBUG_MODE)
                  console.log(` => Fallback patch for meta proxygen pinning`);
                ...
                if (DEBUG_MODE) {
                  console.warn(
                    " Meta unpinning fallback found only untrusted certificates"
                  );
                }
              ...
              console.log(
                `      [+] ${className}->${methodName} (Meta proxygen pinning fallback patch)`
              );
            } else {
              console.error(
