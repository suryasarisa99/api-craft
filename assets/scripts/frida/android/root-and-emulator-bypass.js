...
Java.perform(function () {
  ...
  var CustomProperties = {
    ...
    "ro.build.fingerprint":
      "samsung/starltexx/starlte:10/QP1A.190711.020/G960FXXSDFUG5:user/release-keys",
  ...
  Secure.getString.overload(
    ...
    "java.lang.String"
  ).implementation = function (contentResolver, name) {
  ...
  NativeFile.exists.implementation = function () {
    ...
    var shouldFakeReturn =
      RootBinaries.indexOf(name) > -1 || EmulatorFiles.indexOf(path) > -1;
    if (shouldFakeReturn) {
  ...
  Interceptor.attach(Module.findExportByName("libc.so", "fopen"), {
    onEnter: function (args) {
      ...
      var shouldFakeReturn =
        RootBinaries.indexOf(path) > -1 || EmulatorFiles.indexOf(path) > -1;
      if (shouldFakeReturn) {
